    ...
    def delete(self, code, subject):
        ...
        match subject:
            ...
            case 7:
                homework.subject7 = ""
        if (
            (not homework.subject1)
            and (not homework.subject4)
            and (not homework.subject5)
            and (not homework.subject6)
            and (not homework.subject7)
            and (not homework.subject2)
            and (not homework.subject3)
        ):
